    ...
    grunt.initConfig({
        ...
        concat:{
            js:{
                ...
                dest:'dist/bcwood.combined.js'
            },
            css:{
                src: grunt.file.expand(['app/libs/topcoat-touch/css/*.css', 'app/css/*.css']),
                dest:'dist/bcwood.css'
            }
        },
        uglify:{
            dist:{
                src:['<banner:meta.banner>', 'dist/bcwood.combined.js'],
                dest:'dist/bcwood.min.js'
            }
        },
        cssmin:{
            compress:{
                files:{
                    'dist/bcwood.min.css':['<banner:meta.banner>', 'dist/bcwood.css']
                }
            }
        },
        transform_html:{
        ...
        copy:{
            cordova:{
                files: [
                    ...
                    { dest: 'cordova/www/css/', cwd: 'dist', expand: true, src: 'bcwood.min.css'},
                    { dest: 'cordova/www/js/', cwd: 'dist', expand: true, src: 'bcwood.min.js'},
